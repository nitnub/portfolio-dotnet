...
// var newId = logos != null ? Object.keys(logos).length : 0;
...
function addLogo(projectId) {
    ...
    div.setAttribute("class", "border form-group rounded-2 my-2 shadow bg-white p-2 remove-logo-new" + newId);

    div.innerHTML = `
        <input hidden="" type="number" data-val="true" data-val-required="The Id field is required." id="logos_${newId}__Id" name="Logos[${newId}].Id" value="0"><input name="__Invariant" type="hidden" value="Logos[${newId}].Id">
